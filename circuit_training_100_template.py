...
# initialise the optimizer
    opt = GradientDescentOptimizer(stepsize=0.5)
#     init_params=np.random.rand()
...
#         if ( abs(prev_opt - optimal_value) <= 0.0005 ):
#             break
#         print(i,abs(prev_opt - optimal_value)/optimal_value,optimal_value,prev_opt)
        prev_opt = optimal_value
